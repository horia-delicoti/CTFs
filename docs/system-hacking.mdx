...
### <WikiLink path="/networking/nmap">Nmap</WikiLink>
...
Scan for vulnerabilities using <WikiLink path="/networking/nmap#nse-scripts-to-detect-vulnerabilities">NSE Scripts</WikiLink> to Detect Vulnerabilities.
...
### <WikiLink path="/security/tools/whatweb">WhatWeb</WikiLink>
...
### <WikiLink path="/security/tools/gobuster">GoBuster</WikiLink>

```sh title="To find directories/files"
gobuster dir -u <HOST_IP> -w /usr/share/wordlists/dirb/common.txt
```

### <WikiLink path="/security/tools/wpscan">WPScan</WikiLink>
...
### <WikiLink path="/security/tools/nikto">Nikto</WikiLink>
