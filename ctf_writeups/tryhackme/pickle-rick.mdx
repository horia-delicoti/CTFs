...
Let's use <WikiLink path="/networking/nmap">nmap</WikiLink> to scan the target and gather some information about the services running on it.
...
![Web Page Output](/img/ctf_writeups/tryhackme/pickle-rick/web.png)
...
![Web Source Output](/img/ctf_writeups/tryhackme/pickle-rick/source.png)
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/assets.png" alt="Web Assets Output" width="400"/>
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/login.png" alt="Web Login" width="600"/>
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/command_ls.png" alt="Web Command LS" width="600"/>
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/command_cat_disable.png" alt="Web Command Cat Disabled" width="600"/>
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/command_grep.png" alt="Web Grep Output" width="600"/>
...
<img src="/img/ctf_writeups/tryhackme/pickle-rick/command_sudo.png" alt="Web Command Sudo Output" width="600"/>

You can run **sudo** commands as user `R1ckRul3s`!!
Let's check what else is there.

<img src="/img/ctf_writeups/tryhackme/pickle-rick/command_ls_root.png" alt="Web Command LS Root Output" width="600"/>

On closer inspection, I found the second ingredient Rick needs in the **/home/rick/second ingredients** file.

<img src="/img/ctf_writeups/tryhackme/pickle-rick/ingredient_2.png" alt="Web Command Ingredient 2 Output" width="600"/>

Found the third ingredient in the **/root/3rd.txt** file.

<img src="/img/ctf_writeups/tryhackme/pickle-rick/ingredient_3.png" alt="Web Command Ingredient 3 Output" width="600"/>

We finally have all the ingredients Rick needs to make his serum. We transformed Rick back into a human from a pickle!

<img src="/img/ctf_writeups/tryhackme/pickle-rick/final.jpeg" alt="Web Final" width="300"/>
